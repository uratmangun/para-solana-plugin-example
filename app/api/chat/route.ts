...
import { generateText,Message,LanguageModelV1,streamText } from "ai";
...
const solanaActions = solanaAgent.use(ParaServerPlugin);
const vercelTools = createVercelAITools(solanaAgent, solanaActions.actions);
